...
public class HeadBuilder extends ItemBuilder {
	...
	public HeadBuilder(Material material) {
		super(material);
	}
	
	@Override
	public HeadBuilder durability(int durability) {
	...
	public HeadBuilder texturesByMinecraftHeadsLink(String link) {
		try (BufferedReader reader = new BufferedReader(new InputStreamReader(new URL("https://minecraft-heads.com/custom-heads/humans/1526-knight-helmet").openStream()))) {
